...
/**
 * @brief Tracks if get_programmer_name function has been implemented
 */
static bool not_implemented_get_programmer_name = false;

/**
 * @brief Tracks if prompt_target_enrollment function has been implemented
 */
static bool not_implemented_prompt_target_enrollment = false;

/**
 * @brief Tracks if calculate_growth_rate function has been implemented
 */
static bool not_implemented_calculate_growth_rate = false;

/**
 * @brief Tracks if get_growth_rate_description function has been implemented
 */
static bool not_implemented_get_growth_rate_description = false;

/**
 * @brief Tracks if print_growth_rate function has been implemented
 */
static bool not_implemented_print_growth_rate = false;

/**
 * @brief Tracks if calculate_enrollment_estimate function has been implemented
 */
static bool not_implemented_calculate_enrollment_estimate = false;

/**
 * @brief Tracks if print_enrollment_estimates function has been implemented
 */
static bool not_implemented_print_enrollment_estimates = false;

/**
 * @brief Tracks if get_programmer_name function has crashed
 */
static bool crashes_get_programmer_name = false;

/**
 * @brief Tracks if prompt_target_enrollment function has crashed
 */
static bool crashes_prompt_target_enrollment = false;

/**
 * @brief Tracks if calculate_growth_rate function has crashed
 */
static bool crashes_calculate_growth_rate = false;

/**
 * @brief Tracks if get_growth_rate_description function has crashed
 */
static bool crashes_get_growth_rate_description = false;

/**
 * @brief Tracks if print_growth_rate function has crashed
 */
static bool crashes_print_growth_rate = false;

/**
 * @brief Tracks if calculate_enrollment_estimate function has crashed
 */
static bool crashes_calculate_enrollment_estimate = false;

/**
 * @brief Tracks if print_enrollment_estimates function has crashed
 */
...
void test_2a_file_doxygen(void)
{
	...
	// Check if tfile contains pattern
