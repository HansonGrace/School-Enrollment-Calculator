...
/**
 * @brief Return value if int-returning function is uninmplemented
 */
#define UNIMPLEMENTED_RETURN_INT -999

/**
 * @brief Return value if double-returning function is uninmplemented
 */
#define UNIMPLEMENTED_RETURN_DOUBLE -999.0

/**
 * @brief Return value if unsigned int-returning function is uninmplemented
 */
#define UNIMPLEMENTED_RETURN_UNSIGNED_INT 0

/**
 * @brief Return value if pointer-returning function is uninmplemented
 */
